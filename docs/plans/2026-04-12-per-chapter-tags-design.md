...
- `CRATEDIGGER_1001TL_ARTISTS` ← `DJCache.canonical_name(set_owner_slug)`. For multi-DJ B2B sets, canonical names joined with `, ` (matches existing multi-artist convention).
