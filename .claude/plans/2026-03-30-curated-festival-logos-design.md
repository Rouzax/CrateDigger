...
1. Copy test logos from `/home/martijn/_temp/cratedigger/festivals/` into library `.cratedigger/festivals/{CanonicalName}/logo.*` structure
2. Use thumbnails from `/home/martijn/_temp/cratedigger/thumbs/` for color fallback testing
...
8. Visual check: compare generated posters against test output in `/home/martijn/_temp/cratedigger/test_output_layered/`
