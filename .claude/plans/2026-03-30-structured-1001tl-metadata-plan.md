...
Use the mediainfo metadata JSON at `/home/martijn/_temp/cratedigger/data/mediainfo_metadata.json` to verify the parser handles all 52 entries correctly. Write a quick verification script if needed.
