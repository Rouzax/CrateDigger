...
SAMPLE_SETS = [
    ("Eric Prydz", "UMF Miami", "2026", "Resistance Megastructure",
     ["Progressive House", "Techno"], "19 tracks · 1h 30m"),
    ("Armin van Buuren", "UMF Miami", "2026", "Mainstage",
     ["Trance", "Uplifting"], "34 tracks · 1h 12m"),
    ("Madeon", "Coachella", "2026", "Quasar",
     ["Electronic", "Pop"], "18 tracks · 1h 00m"),
    ("Kaskade", "Coachella", "2026", "Sahara",
     ["House", "Progressive"], "22 tracks · 1h 15m"),
    ("Hardwell", "AMF", "2025", "",
     ["Big Room"], "26 tracks · 1h 02m"),
]
...
def main() -> int:
    ...
    for i, (artist, event, year, note, genres, metric) in enumerate(SAMPLE_SETS):
        ...
        sets.append(EmailSet(artist, event, year, note, genres, metric,
                             poster if poster.exists() else None, "festival_set"))
    report = RunReport(
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        cmd = [
            ...
            f"--screenshot={OUT_PNG}", str(html_path),
        ]
