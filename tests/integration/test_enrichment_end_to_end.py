...
FIXTURE_MKV = Path(
    "/home/user/_temp/cratedigger/data/2026 - Tiësto - We Belong Here.mkv"
)
CONFIG = Path("/home/user/_temp/cratedigger/.cratedigger/config.json")
COOKIES = Path("/home/user/.1001tl-cookies.json")
